...
_$TrendingCourseImpl _$$TrendingCourseImplFromJson(Map<String, dynamic> json) =>
    _$TrendingCourseImpl(
...
Map<String, dynamic> _$$TrendingCourseImplToJson(
        _$TrendingCourseImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
